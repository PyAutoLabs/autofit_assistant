...
remains one conversational assistant, not a swarm of subagents.
...
- Saved Python follows `skills/_style.md` "Generated script style" — domain and
...
Conversational: "Wrap my likelihood function", "Compose this model with priors", "Debug
this search that isn't converging", "Load these results and plot the posterior."

Autonomy: "Fit all three parametrisations and compare their evidence", "Run this analysis
over several sessions and track progress", "Adapt yourself to my domain and set up the
first analysis."
